        ...
        <table class='table table-striped table-bordered' style="margin-top: 20px;"  >
          ...
          <?php
            ...
            while ( $linha = $result->fetch_assoc() ) {
              ...
              $idAux =  $linha["id"];
              $nomeAux =  $linha["nome"];
              $periodoAux =  $linha["periodo"];
              $idPreReqAux =  $linha["idPreReq"];
              ...
              echo "<tr> <td>" . $linha["nome"] . "</td>" .
                    ...
                    "<td>" . "<a class='btn btn-primary' href='alteraDados.php?idDisc=" . $idAux . "&nomeDisc=" . $nomeAux . "&periodoDisc=" . $periodoAux . "&idPreDisc=" . $idPreReqAux . "&creditosDisc=" . $creditos . "'>Alterar</a></td>" .
                    "</tr>";
